...
def brightness_to_ascii(i, density=0):
    """
    Get the appropriate RGB color for each character.
    """
...
def increase_saturation(r, g, b):
    """
    Increase the RGB saturation and return
    """
...
def rgb_to_brightness(r, g, b, grayscale=False):
    """
    Calculate the brightness based on RGB color
    """
    if grayscale:
